...
function ImageUpload({
  ...
  async function uploadImageToCloudinary() {
    ...
    if (response?.data?.success) {
      setUploadedFileUrl(response.data.result.url);
        ...
        {!imageFile ? (
          <Label
            ...
            className=
             ...
             'flex cursor-pointer text-muted-foreground hover:text-foreground border-2 border-dotted h-40 items-center justify-center cursor-pointer'
          >
